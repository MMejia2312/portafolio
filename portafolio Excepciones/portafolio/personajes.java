...
class personajes {
    ...
    protected int vida;
    protected int poder;
    protected int vAtaque;
    /*principales caracteristicas que tendran los personajes
    para facilitar las llamadas de las clases hijos (heredadas) se cambiaron los atributos de encapsualamiento 
    para "nombre" de private a protected
    */
