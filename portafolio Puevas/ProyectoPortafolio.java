...
public class ProyectoPortafolio {
    ...
    public static void main(String[] args) {       
      ...
      */
      ...
      char resp1;
      System.out.println("¿Deceas agregar un aliado extra? (preciona 'S' para si o 'N' para no)");
      ...
      if (resp1 == 's' || resp1 == 'S' ){
          ...
          System.out.println(objPersonaje.getNombre()+" Con una vida de: " + objPersonaje.getVida() + ", y un poder de: "+ objPersonaje.getPoder());
              ...
              System.out.println("oye esa respuesta no es valida");
              System.out.println("Sabes que, ni me molestare.... seguiras tu solo, buena suerte.");
          }
      }
      ...
      char resp2;
      int aux;
      //utilizamos un switch para seleccionar el pueblo al que se decea ir
      switch (opcion){
          case 1: 
      ...
      //sistema para buscar un pueblo en especifico dentro del array pueblos. mediante el metodo de secuencia.
